...
public class BossEnemy : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        health.MaximumHealth = Mathf.Round(15000 + (1000 * (gameObject.transform.position.y / 100)));
        health.CurrentHealth = Mathf.Round(15000 + (1000 * (gameObject.transform.position.y / 100)));
    }
